...
export function createSongSosuo(musicData) {
  return new Song({
    id: musicData.id,
    mid: musicData.mid,
    ...
    album: musicData.mid,
    duration: 240,
    image: `https://vip.suckson.cn/musiclogo/${Math.floor(Math.random() * (15 - 1) + 1)}.jpg`,
    // 歌源url
    // url: `http://thirdparty.gtimg.com/C100${musicData.songmid}.m4a?fromtag=38`
    url: `http://dl.stream.qqmusic.qq.com/C400${musicData.mid}/${musicData.id}.m4a?guid=263427534&fromtag=66`
  })
}
