...
<script>
  ...
  import { createSongSosuo } from 'common/js/song'
    ...
    methods: {
      ...
      _normalizeSongs(list) {
        ...
        list.forEach((musicData) => {
          ...
          if (musicData.docid && musicData.id) {
            var newsong = {}
            console.log(musicData)
            newsong.id = musicData.id
            newsong.mid = musicData.mid
            newsong.singer = musicData.singer
            newsong.name = musicData.name
            newsong.album = musicData.doc
            ret.push(createSongSosuo(newsong))
          }
        })
        return ret
      }
